...
// const htmlDeleteForeverIcon = `XX`;
...
// console.log('htmlDeleteIcon: ', htmlDeleteIcon);
// console.log('htmlDeleteForeverIcon: ', htmlDeleteForeverIcon);
// console.log('uploadIcon: ', renderToStaticMarkup(uploadIcon));
