...
var ReduxFormFieldSimpleReactDropzone = exports.ReduxFormFieldSimpleReactDropzone = function ReduxFormFieldSimpleReactDropzone(props) {
  return _react2.default.createElement(_reduxForm.Field, _extends({}, props, {
    ...
    validate: function validate(value, allValues, reduxFormProps) {
      return props.required && validadeRequired(value, props.existingFiles) || props.validate && props.validate(value, allValues, reduxFormProps, countFiles(value, props.existingFiles));
    }
  }));
};
